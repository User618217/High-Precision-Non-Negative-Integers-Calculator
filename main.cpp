...
// Modulo operation
string mod(const string& num1, const string& num2) {
    if (num2 == "0") return "0"; // Modulo by zero
...
// Power operation (using original algorithm)
string power(const string& base, const string& exp_str) {
